...
class multiAttentionRNN(lasagne.layers.MergeLayer):
    '''
    ...
    def __init__(self, incomings, num_units, 
        ...
        if mask_input is not None:
            incomings.append(mask_input)
        super(multiAttentionRNN, self).__init__(incomings, **kwargs)
        self.num_units = num_units
       
   

        self.W = self.add_param(init, (self.num_units, self.num_units), name='W_wbyw')
