...
def get_args():
    ...
    # Basics
    parser.add_argument('--test_interactive',
                        type='bool',
                        default=True,
                        help='test_interactive: print specific example')

    parser.add_argument('--test_num',
                        type=int,
                        default=145,
                        help='for test_interactive')
    ...
    parser.add_argument('--train_file',
                        type=str,
                        default='/Users/apple/Downloads/proj/Strict/train.txt',
                        help='Training file')

    parser.add_argument('--dev_file',
                        type=str,
                        default='/Users/apple/Downloads/proj/Strict/val.txt',
                        help='Development file')

    parser.add_argument('--test_file',
                        type=str,
                        default='/Users/apple/Downloads/proj/Strict/test.txt',
                        help='Test file')
    ...
    parser.add_argument('--pre_trained',
                        type=str,
                        default='/Users/apple/Downloads/proj/lstm/model1481565914.74.pkl.gz',
    ...
    parser.add_argument('--log_file',
                        type=str,
                        default= '/Users/apple/Downloads/proj/lstm/log.txt',
                        help='Log file')

    parser.add_argument('--embedding_file',
                        type=str,
                        default='/Users/apple/Downloads/proj/wdw_script/glove.6B/glove.6B.100d.txt',
    ...
    parser.add_argument('--max_test',
                        type=int,
                        default=None,
                        help='Maximum number of test examples to evaluate on')
